...
2. **Intermediate Access Checks:** Switches are toggled sequentially to test incorrect or partial passkeys (`2` $\to$ `10`). Pressing the query button evaluates the input through the pipeline, maintaining the locked state (4 LEDs).
